package com.example.haoch.wocao.account_management;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public List<User> getAllUser() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                user.setUser_password(cursor.getString(cursor.getColumnIndex(COLUMN_USER_PASSWORD)));
    ...
    public String searchPass(String uname){
        SQLiteDatabase db = this.getReadableDatabase();
        String query = "select " + COLUMN_USER_NAME + "," + COLUMN_USER_PASSWORD + " from " +  TABLE_USER;
    ...
    public String search_mail(String umail){
        SQLiteDatabase db = this.getReadableDatabase();
        String query = "select " + COLUMN_USER_EMAIL + "," + COLUMN_USER_PASSWORD + " from " +  TABLE_USER;
        Cursor cursor = db.rawQuery(query, null);
        String a,b;
        b = "not found";
        if (cursor.moveToFirst()){
            do {
                a = cursor.getString(0);   //usermail
                if (a.equals(umail)){
                    b = cursor.getString(1);   //password
                    break;
                }
